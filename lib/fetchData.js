...
export async function fetchDemoSection() {
  const demoSectionQuery = groq`*[_type == "demoSection"]{
    _id,
    title,
    description,
  }`;
...
export async function fetchPractitionersKeyFeature() {
  const practitionersKeyFeatureQuery = groq`*[_type == "practitionersKeyFeature"]{
    _id,
    title,
    description,
  }`;
...
export async function fetchReferralSection() {
  const referralSectionQuery = groq`*[_type == "referralSection"]{
    _id,
    title,
    description,
  }`;
...
export async function fetchPatientsFeatureContent() {
  const patientsFeatureContentQuery = groq`*[_type == "patientsFeatureContent"]{
    _id,
    title,
    description,
  }`;
